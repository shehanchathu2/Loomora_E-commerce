...
const Cart = () => {
  ...
  return (
    <div className="mt-10 border-t-2 pt-10 transition-opacity ease-out duration-500 opacity-100 my-10 px-6 sm:px-10 md:px-16 lg:px-20 xl:px-28">
      <div className="text-2xl mb-3 flex justify-start">
            ...
            return (
              <div key={index} className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-3">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <p className="textxm sm:text-lg font-medium">{productData.name}</p>
        ...
        <div className="flex justify-end my-20">
          <div className="w-full sm:w-[450px]">
            ...
            <div className="w-full text-end">
              <button onClick={() => navigate('/placeorder')} className="mt-6 bg-black text-white px-6 py-3 hover:bg-gray-800 transition-colors duration-300">PROCEED TO CHECKOUT</button>
            </div>
          </div>
        </div>
      </div>
